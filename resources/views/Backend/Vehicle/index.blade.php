                                    ...
                                    <table id="datatable-responsive"
                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-label="First name: activate to sort column descending">Vehicle
                                                    Number
                                                    ID</th>
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 83px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">Driver
                                                    Full Name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                   {{-- @php
                                                        $user = \App\Model\User::where('id',$vehicle->user->id)->first();
                                                    @endphp
                                                    {{$user->username}} --}}

                                                    {{optional($vehicle->user)->fname}}
                                                </td>
                                                <td>
                                                    <div class="row">
                                                        <a name="" id="" class="mr-3 ml-3"
                                                            href="{{route('dashboard.vehicle.edit',$vehicle->id)}}"
                                                            role="button">
                                                            <div>
