                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 83px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">Category
                                                    name</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td class="d-flex justify-content-center">
                                                    <img src="{{url('upload/category',$category->image)}}"
                                                        class="img-thumbnail" alt="" width="50px">
                                                </td>
                                                <td tabindex="0" class="sorting_1">{{$category->catname}}</td>
                                                <td tabindex="0" class="sorting_1">{{$category->description}}</td>
                                                {{-- datatable action --}}
                                                <td>
                                                    <div class="row">
                                                        <a name="" id="" class=" mr-3 ml-3"
                                                            href="{{route('dashboard.category.show',$category->id)}}"
                                                            role="button">
                                                            <div>
