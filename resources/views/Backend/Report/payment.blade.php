    ...
    <div class="col-md-12 col-sm-12  ">
        <div class="x_panel">
            <div class="x_title">
                ...
                <h2>Payment Report Generate</small></h2>
            ...
            <form action="{{ route('dashboard.report.paymentFilter') }}" method="post">
                @csrf
                <div class="col-md-12 col-sm-12">
            ...
            <div class="x_content">
                <h1 class="text-center mb-3"> Payment Report
                </h1>
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        @endphp
                            <tr>
                                <th scope="row">{{ $payment->updated_at->format('Y-m-d') }}</th>
