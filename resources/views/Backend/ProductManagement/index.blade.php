                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="First name: activate to sort column descending">Product
                                                        ID</th>
                                                    <th class="sorting_asc" tabindex="0"
                                                        aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                        style="width: 83px;" aria-sort="ascending"
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                        ...
                                                        aria-label="Last name: activate to sort column ascending">Product
                                                        Status
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    ...
                                                    <tr role="row" class="odd">
                                                        <td class="d-flex justify-content-center">
                                                            <img src="{{ url('upload/product', $product->image) }}"
                                                                class="img-thumbnail" alt="" width="75px">
                                                        </td>
                                                        <td>{{ $product->proname }}</td>


                                                        <td>{{optional($product->brand)->brandname}}</td>

                                                        <td>
                                                            @foreach ($product->categories as $item)
                                                                <div class="badge badge-primary">{{ $item->catname }}
                                                                </div>
                                                                <br>
                                                            @endforeach
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="row">
                                                                <a name="" id="" class=" mr-3 ml-3"
                                                                    href="{{ route('frontend.product.index', $product->slug) }}"
                                                                    role="button">
                                                                    <div>
                                                                ...
                                                                <a name="" id="" class="mr-3"
                                                                    href="{{ route('dashboard.product.edit', $product->id) }}"
                                                                    role="button">
                                                                    <div>
                                                                ...
                                                                @can('super-user')
                                                                    <form
                                                                        ...
                                                                        <button type="submit" class="del-btn"
                                                                            data-toggle="modal" data-target="#myModal-d">
