                                        ...
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0"
                                                    ...
                                                    aria-label="First name: activate to sort column descending">Supplier Name
                                                    name</th>
                                                ...
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 180px;"
                                                    aria-label="Position: activate to sort column ascending">Contact Details
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 180px;"
                                                ...
                                                <td>
                                                    <div class="row">
                                                        ...
                                                        <a name="" id="" class="mr-3"
                                                            href="{{route('dashboard.supplier.edit',$supplier->id)}}"
                                                            role="button">
                                                            <div>
