...
<div class="x_content">
<br>
<form class="form-label-left input_mask" action="{{route('dashboard.supplier.store')}}" method="POST">
	@csrf
...
<div class="col-md-6 col-sm-6 ">
<input type="email" class="form-control has-feedback-right" name="email" id="inputSuccess4" placeholder="">
@error('email')
    <p class="text-danger">{{$message}}</p>
@enderror
...
<div class="col-md-6 col-sm-6 ">
<input type="tel" class="form-control" id="inputSuccess5" name="contact" placeholder="">
@error('contact')
    <p class="text-danger">{{$message}}</p>
@enderror
