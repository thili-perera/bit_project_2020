                                        ...
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 83px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">Last
                                                    Name</th>
                                                <th class="sorting_asc" tabindex="0"
                                                    aria-controls="datatable-responsive" rowspan="1" colspan="1"
                                                    style="width: 83px;" aria-sort="ascending"
                                                    aria-label="First name: activate to sort column descending">User
                                                    name</th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                                    rowspan="1" colspan="1" style="width: 81px;"
                                                    aria-label="Last name: activate to sort column ascending">Position
                                                </th>
                                                <th class="sorting" tabindex="0" aria-controls="datatable-responsive"
                                        ...
                                        <tbody>
                                            ...
                                            <tr role="row" class="odd">
                                                <td class="d-flex justify-content-center">
                                                    @if ($user->image)
                                                        <img src="{{url('upload/user',$user->image)}}" class="img-thumbnail"
                                                        alt="" width="50px">
                                                    @else
                                                ...
                                                <td class=" ">
                                                    ...
                                                    <span class="badge badge-info">{{$role->rname}}</span>
                                                    @endforeach
                                                </td>
                                                {{-- datatable action --}}
                                                <td>
