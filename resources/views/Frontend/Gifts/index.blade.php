        ...
        <div class="container">
            <div class="row">
                <div class="header text-center">
                    <h3 class="small-title">Gift Basket</h3>
                ...
                @if (Session::has('gift'))
                        ...
                        <div class="wishlist-entry clearfix">
                            ...
                            <div class="col-md-2 col-sm-2">
                                <ul class="quantity-selector">
                                    ...
                                    <form action="{{ route('frontend.gift.updatequantity', $product['id']) }}"
                                        method="post">
                                        @csrf
                                        @method('PUT')
                            ...
                            <div class="col-md-2 col-sm-2 entry">
                                <form action="{{ route('frontend.gift.itemdelete', $product['id']) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    <input type="hidden" name="productid" value="{{ $product['id'] }}">
                    ...
                    <div class="text-right">
                        <a href="{{ route('frontend.checkout.giftcheckout') }}" class="btn btn-common"
                            style="margin-top: 20px;">Go to
                            Checkout</a>
                    </div>
                @else
