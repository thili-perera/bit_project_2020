          ...
          <div class="col-md-3 col-sm-3 col-xs-12">
            ...
            @foreach ($productcategories as $category)
                <li class="dropdown mb-20">
                  <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion-category" href="{{ route('frontend.category.catpage', $category->slug) }}">{{$category->catname}} <span><i class="icon-arrow-down"></i></span></a>
            ...
            <div class="shop-content">
              <div class="col-md-12">
                <div class="product-option mb-30 clearfix">
                  <ul class="shop-tab">
                    <li class="active"><a aria-expanded="true" href="#grid-view" data-toggle="tab">{{$search}}</a></li>
                    ...
                    <div class="shop-product">
                      ...
                      <div class="product-info">
                        ...
                        <div class="align-items">
                          <div class="pull-left">
                            <span class="price">Rs. {{$product->salesprice}}</span>
                          </div>
                        </div> 
                      </div>
                    </div>             
