                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label>Telephone <sup>*</sup></label>
                                    <input class="form-control" type="text" pattern="[0-9]{10}" required  @isset($shipping->shipping_phone)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form action="{{route('frontend.checkout.store')}}" method="post">
                                                    @csrf
                                                <div>
                                                    <button type="submit" value="calship" class="btn btn-primary">Calculate Shipping</button>
