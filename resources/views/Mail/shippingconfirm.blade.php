                    ...
                    <tr>
                        <td bgcolor="#ffffff" align="center" valign="top"
                            ...
                            <h1 style="font-size: 36px; font-weight: 800; margin-top: 30px; color: #000;">
                                Order Dispatched</h1>
                            <img src="https://cdn.iconscout.com/icon/free/png-512/truck-shipping-logistic-delivery-transport-supply-vehicle-export-5-20575.png"
                ...
                <table border="0" cellpadding="10px" cellspacing="0" width="100%" style="max-width: 600px;">
                    <tr>
                        <td bgcolor="#ffffff" align="left"
                            ...
                            <p style="margin: 0;">
                                <h2 align="center">Your order has been shipped!</h2>
                                <p><b>Hello, {{$fname}}</b></p>
                                <p>Item(s) from your order <b>{{$order_number}}</b> are with our shipping partner <b>{{$deliver_person}}</b>! Details on when
                                    you can expect it at your doorstep are provided below.</p>
                                <span>We will update you again if there is any outstanding item(s) in your order.</span>
