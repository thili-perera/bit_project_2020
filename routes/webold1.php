...
// Dashboard Welcome
Route::namespace('Backend\Home')->prefix('dashboard')->name('dashboard.')->middleware('can:super-user')->group(function () {
...
Route::namespace('Backend\User')->prefix('dashboard')->name('dashboard.user.')->middleware('can:manage-users')->group(function () {
    ...
    // Route::put('/update/user/{user}', 'UserController@update')->name('update');
...
Route::get('dashboard/userprofile/{user}', 'Backend\User\UserController@userprofile')->middleware('can:alluser')->name('dashboard.user.userprofile');

/* Role Mamangement */

Route::namespace('Backend\Role')->prefix('dashboard')->name('dashboard.role.')->middleware('can:manage-users')->group(function () {
    Route::get('/allroles', 'RoleController@index')->name('index');
    Route::get('/addrole', 'RoleController@create')->name('create');
    Route::post('/rolestore', 'RoleController@store')->name('store');
    Route::delete('/roledestroy/{id}', 'RoleController@destroy')->name('destroy');
});
...
Route::namespace('Backend\Delivery')->prefix('dashboard')->name('dashboard.delivery.')->middleware('can:alluser')->group(function () {
...
Route::namespace('Backend\Report')->prefix('dashboard')->name('dashboard.report.')->middleware('can:manage-users')->group(function () {
    ...
    Route::get('/report/product', 'ReportController@product')->name('product');
    ...
    Route::post('/report/productFilter', 'ReportController@productFilter')->name('productFilter');
